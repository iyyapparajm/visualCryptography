...
import javax.imageio.*;
 ...
 JButton open = new JButton("Open"), embed = new JButton("Embed"),
    ...
    private final JButton btnEncodeText = new JButton("Encode Text");
    ...
    private void assembleInterface() {
       ...
       btnEncodeText.addActionListener(new ActionListener() {
       	public void actionPerformed(ActionEvent arg0) {
       		try {
				String enctext=Encodetext.encode(message.getText());
				message.setText(enctext);
			} catch (Exception e) {
       ...
       embeddedPane.setBorder(BorderFactory.createTitledBorder("embedded Image"));
